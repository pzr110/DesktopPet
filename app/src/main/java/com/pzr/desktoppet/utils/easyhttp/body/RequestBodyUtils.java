...
package com.pzr.desktoppet.utils.easyhttp.body;
...
public class RequestBodyUtils {
    ...
    public static RequestBody getJSONRequestBody(HashMap params) {
        return RequestBody.create(MediaType.parse("application/json"), GsonUtils.toJson(params));
    }
    ...
    public static <T> RequestBody getJSONRequestBody(T t) {
        String newCarInfoJson = GsonUtils.toJson(t);
