...
import com.pzr.desktoppet.utils.easyhttp.body.ProgressResponseCallBack;
import com.pzr.desktoppet.utils.easyhttp.body.RequestBodyUtils;
import com.pzr.desktoppet.utils.easyhttp.body.UploadProgressRequestBody;
import com.pzr.desktoppet.utils.easyhttp.model.HttpParams;
import com.pzr.desktoppet.utils.easyhttp.token.DynamicTokenInterceptor;
...
public abstract class BaseBodyRequest<R extends BaseBodyRequest> extends BaseRequest<R> {
    ...
    public R requestBody(RequestBody requestBody) {
        if (accessToken) {
            interceptors.add(new DynamicTokenInterceptor());
        }
