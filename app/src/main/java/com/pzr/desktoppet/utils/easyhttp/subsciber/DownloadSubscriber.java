...
package com.pzr.desktoppet.utils.easyhttp.subsciber;
...
import com.pzr.desktoppet.utils.easyhttp.callback.DownloadProgressCallBack;
...
public class DownloadSubscriber<ResponseBody extends okhttp3.ResponseBody> extends BaseSubscriber<ResponseBody> {
    ...
    public void onNext(ResponseBody responseBody) {
        HttpLog.e("DownSubscriber:>>>> onNext");
        ...
        try {
           ...
           /* if (!futureStudioIconFile.exists()) {
            ...
            try {
                ...
                HttpLog.e("file length: " + fileSize);
